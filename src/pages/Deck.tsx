...
import { DeckHeader, PracticeHero, Label } from "@/components/Deck";
...
export default function Deck({ deckId, onBack, onStudy, onPractice }: DeckProps) {
  const { user } = useAuth();
  const { decks, loading: decksLoading, updateDeckCount, renameDeck, pinDeck, setDeckPublic } = useDecks();
      ...
      <Box>
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1.5 }}>
          ...
          <Button
            ...
            sx={{
              borderRadius: "9px", px: 2, py: "5px", fontSize: "0.76rem",
              textTransform: "none", fontWeight: 700, mb: 1.5,
            }}
          >
            Add Cards
          </Button>
        ...
        {cards.length === 0 ? (
          <Box
            sx={{
              ...
              borderRadius: "14px", p: 6, textAlign: "center", bgcolor: "rgba(255,255,255,0.6)",
            }}
          >
