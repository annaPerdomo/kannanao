          ...
          <>
            ...
            >
              ...
              <FormControlLabel
                ...
                label="" sx={{ m: 0 }} onClick={(e) => e.stopPropagation()}
              />
            </Box>
            ...
            <AddCardsSection
              words={words} onWordsChange={setWords} input={input} onInputChange={setInput}
              disabled={busy} error={error} mainViewMode={mainViewMode} onMainViewModeChange={setMainViewMode}
              onAddExisting={handleAddExisting} onImportPdf={handleImportPdf}
              containerSx={{
