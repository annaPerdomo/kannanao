      ...
      <Box sx={{
        ...
        <Box sx={{ ...faceStyle, bgcolor: '#ffffff' }}>
          ...
          <Box sx={{
            ...
            {card.jlptLevel ? (
              <Box sx={{ px: 1, py: 0.3, borderRadius: '5px', bgcolor: '#f4f4f8', border: '1px solid #e0e0ea' }}>
                <Typography sx={{ fontSize: '0.62rem', color: '#777', letterSpacing: '0.08em', fontFamily: (t) => t.fonts.mono }}>
                  JLPT {card.jlptLevel}
                </Typography>
              </Box>
            ) : <Box />}
          ...
          <Box sx={{ px: 2.5, py: 1, borderTop: '1.5px solid #f0f0f5', display: 'flex', justifyContent: 'center' }}>
            <Typography sx={{ fontSize: '0.6rem', color: '#999', letterSpacing: '0.15em', fontFamily: (t) => t.fonts.mono, textTransform: 'uppercase' }}>
              click to flip
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ ...faceStyle, bgcolor: '#fafafa', transform: 'rotateY(180deg)' }}>
          ...
          <Box sx={{ px: 2.5, py: 1.25, borderBottom: '1.5px solid #ebebef' }}>
            <Typography sx={{ fontSize: '0.65rem', color: '#777', textTransform: 'uppercase', letterSpacing: '0.12em', fontFamily: (t) => t.fonts.mono }}>
              Answer
            </Typography>
          </Box>
          ...
          <Box sx={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
            ...
            <Box sx={{
              ...
              {isKanji && card.reading && (
                <Box>
                  <Typography sx={{ fontSize: '0.58rem', color: '#888', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: (t) => t.fonts.mono, mb: 0.5 }}>
                    Reading
                  </Typography>
                  <Typography sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '1.1rem', fontWeight: 600, color: '#333', whiteSpace: 'nowrap' }}>
                    {card.reading}
                  </Typography>
                </Box>
              )}
              ...
              <Box>
                ...
                <Typography sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '1.1rem', fontWeight: 700, color: '#222', fontStyle: 'italic', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
                  {card.meaning}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ flex: 1, px: 2.5, py: 2, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 0.75 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.5 }}>
                <Typography sx={{ fontSize: '0.58rem', color: '#888', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: (t) => t.fonts.mono }}>
                  Example
                </Typography>
                <SpeakButton text={stripFurigana(card.example_jp)} />
              </Box>
              <Typography component="div" sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '0.95rem', color: '#222', lineHeight: 2.2 }}>
