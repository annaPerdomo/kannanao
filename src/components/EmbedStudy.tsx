      ...
      <Box sx={{
        ...
        <Box sx={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          ...
          >
            ...
            {cardTheme !== "plain" && !navigating && SPARKLE_ITEMS.map((s, i) => (
              <Box key={i} sx={{
          ...
          <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 4, mt: 2.5 }}>
            <IconButton
              onClick={() => navigate(-1)}
