...
export function SpeechPracticeTiles({ canPractice, onPractice }: SpeechPracticeTilesProps) {
  ...
  const tileThemes = [
    {
      color: accent[700],
      bg: `linear-gradient(135deg, ${accent[50]} 0%, ${alpha(accent[100], 0.8)} 100%)`,
      border: alpha(accent[300], 0.7),
      shadowColor: alpha(accent[700], 0.22),
    },
    {
      color: brand[700],
      bg: `linear-gradient(135deg, ${brand[50]} 0%, ${alpha(brand[100], 0.8)} 100%)`,
      border: alpha(brand[300], 0.7),
      shadowColor: alpha(brand[700], 0.22),
    },
  ];
            ...
            >
              ...
              <Typography
                sx={{
                  fontSize: '0.7rem',
                  fontWeight: 800,
                  color: canPractice ? color : 'text.disabled',
                  letterSpacing: '0.04em',
                  opacity: canPractice ? 0.8 : 0.5,
                  alignSelf: 'flex-end',
                }}
              >
