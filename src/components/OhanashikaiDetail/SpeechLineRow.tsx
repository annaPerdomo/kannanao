            ...
            <Tooltip title={t('editLine')}>
              <IconButton
                ...
                sx={{
                  ...
                  height: 26,
                  borderRadius: '8px',
                  color: alpha(brandPalette[600], 0.5),
                  '&:hover': { bgcolor: brandPalette[50], color: brandPalette[600] },
                }}
              >
            ...
            <Tooltip title={t('deleteLine')}>
              <IconButton
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: 'rgba(251,113,133,0.1)', color: 'error.main' },
                }}
              >
