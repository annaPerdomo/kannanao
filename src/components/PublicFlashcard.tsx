            ...
            <Box sx={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
              ...
              <Box sx={{
                ...
                {isKanji && card.reading && (
                  <Box>
                    <Typography sx={{ fontFamily: (t) => t.fonts.mono, fontSize: '0.58rem', color: brand[500], letterSpacing: '0.12em', fontWeight: 700, mb: 0.5, textTransform: 'uppercase' }}>
                      ★ Reading
                    </Typography>
                    <Typography sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '1.1rem', fontWeight: 700, color: '#111', lineHeight: 1.2, whiteSpace: 'nowrap' }}>
                      {card.reading}
                    </Typography>
                  </Box>
                )}
                ...
                <Box>
                  ...
                  <Typography sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '1.1rem', fontWeight: 700, color: '#111', fontStyle: 'italic', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
                    {card.meaning}
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ flex: 1, px: 2, py: 1.5, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 0.5 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.5 }}>
                  <Typography sx={{ fontFamily: (t) => t.fonts.mono, fontSize: '0.58rem', color: brand[500], letterSpacing: '0.12em', fontWeight: 700, textTransform: 'uppercase' }}>
                    ★ Example
                  </Typography>
                  <SpeakButton text={stripFurigana(card.example_jp)} iconSize="0.85rem" />
                </Box>
                <Typography component="div" sx={{ fontFamily: (t) => t.fonts.jp, fontSize: '0.95rem', color: '#111', lineHeight: 2.2 }}>
