  ...
  if (done) {
    return (
      <Box sx={{ textAlign: 'center', py: 6 }}>
        ...
        <Typography variant="h4" sx={{ mb: 1 }}>Session Complete!</Typography>
  ...
  return (
    <Box>
      ...
      <LinearProgress
        ...
        sx={{ mb: 4, height: 3, borderRadius: 1, bgcolor: 'rgba(200,169,126,0.1)', '& .MuiLinearProgress-bar': { bgcolor: 'primary.main' } }}
      />
        ...
        {card.imageUrl ? (
          <>
            <Box
              ...
              src={card.imageUrl}
              alt="prompt"
              sx={{ width: '100%', height: '100%', objectFit: 'cover', filter: result ? 'none' : 'blur(8px) brightness(0.5)', transition: 'filter 0.4s' }}
            />
            {!result && (
              <Box
                sx={{
              ...
              >
                <Typography variant="caption" sx={{ color: 'rgba(240,237,230,0.6)', letterSpacing: '0.1em' }}>
                  WHAT IS THIS WORD?
                </Typography>
                <Typography
                  variant="caption"
                  sx={{ color: 'primary.main', letterSpacing: '0.08em', cursor: 'pointer', '&:hover': { textDecoration: 'underline' } }}
      ...
      {result && (
        <Box
          sx={{
            ...
            bgcolor: result === 'correct' ? 'rgba(126,184,154,0.08)' : 'rgba(224,112,112,0.08)',
            mb: 2,
            display: 'flex',
            alignItems: 'center',
            gap: 1.5,
