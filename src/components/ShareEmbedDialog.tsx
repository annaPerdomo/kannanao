    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth slotProps={{ paper: { sx: dialogPaperSx } }}>
      ...
      <DialogContent sx={{ pt: "20px !important", px: 2.5 }}>
        ...
        <Box sx={{
          ...
          <Box>
            <Typography sx={{ fontWeight: 700, fontSize: "0.9rem", fontFamily: '"Nunito",sans-serif', color: "text.primary" }}>
              Public embedding
            </Typography>
        ...
        {isPublic && (
          <>
            ...
            <Box sx={{ mt: 2, p: 1.5, borderRadius: 2, bgcolor: alpha(brand[50], 0.8), border: `1px solid ${alpha(brand[200], 0.5)}` }}>
              <Typography sx={{ fontSize: "0.72rem", fontWeight: 700, color: brand[700], mb: 0.75, fontFamily: '"Nunito",sans-serif' }}>
              ...
              {[
                ...
                <Box key={i} sx={{ display: "flex", gap: 1, mb: 0.5 }}>
                  <Typography sx={{ fontSize: "0.68rem", color: brand[500], fontWeight: 800, minWidth: 14, fontFamily: '"DM Mono",monospace' }}>
                    {i + 1}.
                  </Typography>
