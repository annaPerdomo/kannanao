...
describe('DeckCard', () => {
  it('should render the deck name', () => {
    ...
    renderWithProviders(
      <DeckCard deck={deck} onOpen={vi.fn()} onDelete={vi.fn()} />,
    );
  ...
  it('should call onOpen with deck id when card body is clicked', () => {
    ...
    renderWithProviders(
      <DeckCard deck={deck} onOpen={onOpen} onDelete={vi.fn()} />,
    );
  ...
  it('should show pinned indicator when deck is pinned', () => {
    ...
    const onPin = vi.fn();
    renderWithProviders(
      <DeckCard deck={deck} onOpen={vi.fn()} onDelete={vi.fn()} onPin={onPin} />,
    );
  ...
  it('should call onDelete when delete button is clicked', () => {
    ...
    renderWithProviders(
      <DeckCard deck={deck} onOpen={vi.fn()} onDelete={onDelete} />,
    );
