...
interface XpPopProps { show: boolean }
...
export function XpPop({ show }: XpPopProps) {
  ...
  return (
    <Box sx={{
      position: 'absolute', top: '-6px', right: 6, pointerEvents: 'none', zIndex: 10,
      fontSize: '0.72rem', fontWeight: 800, color: 'secondary.dark',
      background: `linear-gradient(90deg, ${brand[100]}, ${accent[100]})`,
      border: `1.5px solid ${alpha(accent[300], 0.5)}`,
      borderRadius: 2.5, px: 0.75, py: 0.25, whiteSpace: 'nowrap',
