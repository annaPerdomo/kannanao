...
export function SortableTodoItem({ todo, viewDateISO, onToggle, onEditEmoji, onDelete, onAdvancedEdit, onXpEarned, brand }: SortableTodoItemProps) {
  ...
  const dragHandle = (
    <Box
      ...
      {...attributes}
      sx={{
        display: 'flex', alignItems: 'center', cursor: 'grab', flexShrink: 0,
        color: alpha(brand[300], 0.6), transition: 'color 0.15s',
        ml: -0.5, mr: -0.25,
