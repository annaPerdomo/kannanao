          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}
            ...
            {session ? (
              <Button variant="contained" size="large" onClick={() => router.push('/')}
                sx={{ fontFamily: (t) => t.fonts.display, fontSize: '1.05rem', textTransform: 'none', borderRadius: 8, px: 4, py: 1.5,
              ...
              <>
                ...
                <Button variant="outlined" size="large" onClick={() => router.push('/login')}
                  sx={{ fontFamily: (t) => t.fonts.display, fontSize: '1.05rem', textTransform: 'none', borderRadius: 8, px: 3.5, py: 1.5,
