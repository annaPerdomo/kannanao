        ...
        <Box sx={{
          ...
          {MODES.map((m, i) => (
            ...
            >
              ...
              <Typography sx={{ fontFamily: (t) => t.fonts.display, fontSize: '1.3rem', color: m.color }}>
                {m.title}
              </Typography>
            ...
            <Paper elevation={0} sx={{
              ...
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Typography sx={{ fontSize: '0.62rem', color: macChrome.text, letterSpacing: '0.02em', fontFamily: (t) => t.fonts.mono }}>
              ...
              <Box sx={{ px: 2, py: 1.25, bgcolor: macChrome.footerBg, borderTop: `1px solid ${macChrome.footerBorder}` }}>
                <Typography sx={{ fontSize: '0.62rem', color: macChrome.text, textAlign: 'center', fontFamily: (t) => t.fonts.mono }}>
                  Powered by 🌸 Kannanao
                </Typography>
              </Box>
            </Paper>
