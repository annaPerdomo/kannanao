...
const FALL_PETALS = [
  { id: 0, left: '4%', size: 14, dur: 10.5, delay: 0, anim: 'sakuraFall-l', opacity: 0.5 },
  { id: 1, left: '12%', size: 11, dur: 12.0, delay: 1.8, anim: 'sakuraFall-r', opacity: 0.4 },
  ...
  { id: 4, left: '39%', size: 15, dur: 10.0, delay: 4.2, anim: 'sakuraFall-r', opacity: 0.5 },
  ...
  { id: 10, left: '88%', size: 14, dur: 9.5, delay: 2.8, anim: 'sakuraFall-r', opacity: 0.5 },
  ...
  { id: 13, left: '43%', size: 15, dur: 11.0, delay: 8.2, anim: 'sakuraFall-l', opacity: 0.5 },
...
export function SakuraFallEffect() {
  return (
    <Box
      sx={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden', zIndex: 0 }}
    >
      {FALL_PETALS.map((p) => (
        <Box
          key={p.id}
